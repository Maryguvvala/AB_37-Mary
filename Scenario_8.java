package scenarios.project;//check if products can be sorted by relevance,price,rating.etc.
...
public class Scenario_8 
{
	public static void main(String[] args) throws EncryptedDocumentException, IOException
	{
        ...
        WebElement sortdropdown =  driver.findElement(By.xpath("(//span[@class='a-button-inner'])[26]"));
        sortdropdown.click();
       // WebElement price =  driver.findElement(By.linkText("Price: Low to High"));
        //price.click();
        WebElement review =  driver.findElement(By.linkText("Avg. Customer Review"));
        review.click();
        //WebElement newarrival =  driver.findElement(By.linkText("Newest Arrivals"));
       // newarrival.click();
